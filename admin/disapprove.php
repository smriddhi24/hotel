...
<!-- page details -->
	<div class="breadcrumb-mobamu">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page">Disapprove</li>
		</ol>
	</div>
<!-- //page details -->
<!-- booking form -->
	<div class="register-w3 py-5">
		<div class="container py-xl-5 py-lg-3 table-responsive">
			<h3 class="tittle text-center text-bl font-weight-bold">Disapprove</h3>
			<table class="table">
			  ...
			  <tbody>
					...
					<?php
					 include "config.php";
					 $q = "select * from `booking_request` where `status`='disapproved'";
